...
waypoints = np.array([[-6, 3], [2, 3], [2, -1], [3, -4]]) # default ([[-6, 3], [2, 3], [2, -1], [3, -4]])
...
MP_new = dmp.DMPs_cartesian(n_dmps = 2, n_bfs = 250, K = 7500, dt = Ts, T = tVec[-1], alpha_s = 2.0, tol = 3.0 / 100, rescale = None, basis = "gaussian")
...
plt.figure()
plt.plot(train_filvel[:,0],train_filvel[:,1],'b-',)
plt.plot(learnt_vel[:,0],learnt_vel[:,1],'r--')
